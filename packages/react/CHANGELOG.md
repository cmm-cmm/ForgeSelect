...
- New core options for selection guards, async tag creation, template sanitization, data-integrity policies, and cursor pagination are available through the existing typed props surface.
